...
@Component({
  selector: 'WalkerSchedule-home',
  templateUrl: './WalkerSchedule-home.component.html',
  styleUrls: ['./WalkerSchedule-home.component.scss']
})
export class WalkerScheduleHomeComponent implements AfterViewInit {
