...
@Component({
  selector: 'WalkService-home',
  templateUrl: './WalkService-home.component.html',
  styleUrls: ['./WalkService-home.component.scss']
})
export class WalkServiceHomeComponent implements AfterViewInit {
