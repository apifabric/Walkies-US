...
resourcename="walkies-us"  # lower case, only
resourcegroup="walkies-us_rg"
...
# git clone https://github.com/apilogicserver/walkies-us.git
# cd walkies-us
...
az group create --name walkies-us_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group walkies-us_rg --sku S1 --is-linux
az container create --resource-group walkies-us_rg --name walkies-us --image apilogicserver/walkies-us:latest --dns-name-label walkies-us --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//walkies-us.westus.azurecontainer.io:5656'
