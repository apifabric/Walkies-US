...
def expose_models(api, method_decorators = []): 
    ...
    api.expose_object(database.models.WalkerSchedule, method_decorators= method_decorators)
    ...
    api.expose_object(database.models.Subscription, method_decorators= method_decorators)
